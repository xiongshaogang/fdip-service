...
public class Fund implements Serializable{
	...
	//个人首次申购最小份额
	private BigDecimal fstMinPurchaseAmount = new BigDecimal("0");
	
	//最大申购份额
	private BigDecimal maxPurchaseAmount = new BigDecimal("0");
	
	//最小赎回份额
	private BigDecimal minRedemption = new BigDecimal("0");
	
	//最大赎回份额
	private BigDecimal maxRedemption = new BigDecimal("0");
	
	//最小持有份额
	private BigDecimal minAccountBalance = new BigDecimal("0");
